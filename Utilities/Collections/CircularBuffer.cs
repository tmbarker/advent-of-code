...
public class CircularBuffer<T> : IEnumerable<T>
{
    ...
    /// <summary>
    /// The buffer content is comprised of up to two non-contiguous segments: [d,e,...,a,b,c]<para />
    ...
    /// <summary>
    /// The buffer content is comprised of at most two non-contiguous segments: [d,e,...,a,b,c]
    /// </summary>
